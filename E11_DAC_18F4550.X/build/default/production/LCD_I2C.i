...
void PCF8574_Write(uint8_t byte){
    ...
    I2C_Start();
    I2C_ADDRESS_SLAVE((0x40 | (0x07<<1)),0x00);
    I2C_Write_Data((byte | 0x08));
    I2C_Stop();
}
...
void LCD_I2C_Databus(char ctrl,char cmd){
    ...
    _delay((unsigned long)((60)*(20000000UL/4000000.0)));
    ...
    _delay((unsigned long)((2)*(20000000UL/4000000.0)));
    PCF8574_Write(data &~ 0x04);
}
...
void LCD_I2C_Init(void){
    ...
    I2C_Write_Data(0x00);
    I2C_Stop();
    _delay((unsigned long)((15)*(20000000UL/4000.0)));
# 86 "LCD_I2C.c"
