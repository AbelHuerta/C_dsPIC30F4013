...
${OBJECTDIR}/Main_Dis.o: Main_Dis.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Main_Dis.o.d 
	@${RM} ${OBJECTDIR}/Main_Dis.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Main_Dis.c  -o ${OBJECTDIR}/Main_Dis.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Main_Dis.o.d"      -g -D__DEBUG     -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp=${DFP_DIR}/xc16
	@${FIXDEPS} "${OBJECTDIR}/Main_Dis.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/Main_Dis.o: Main_Dis.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Main_Dis.o.d 
	@${RM} ${OBJECTDIR}/Main_Dis.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Main_Dis.c  -o ${OBJECTDIR}/Main_Dis.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Main_Dis.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp=${DFP_DIR}/xc16
	@${FIXDEPS} "${OBJECTDIR}/Main_Dis.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
